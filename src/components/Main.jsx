  ...
  return (
    <div className='Main'>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-around' }}>
        ...
        <img src="https://sonic.sega.jp/SonicChannel/enjoy/image/wallpaper_229_metal_07_pc.png" alt="Metal" style={{ width: '45%', borderRadius: '10px', border: 'solid white 3.5px' }} />
      </div>
      <h1>&nbsp;</h1>
